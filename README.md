...
- [hermes-edu-skills](https://github.com/zhongweiv/hermes-edu-skills) - Chinese education Agent Skill Pack: 188 skills for K-12 learning, exam prep, homework help, and teacher workflows (195⭐) ⭐ NEW
...
- [Hindsight](https://github.com/vectorize-io/hindsight) - Agent memory that learns - adaptive memory system improving retrieval over time (13300⭐, May 2026) ⭐ NEW
- [remindb](https://github.com/radimsem/remindb) - Agentic memory database cutting session tokens by 75–99%. Portable SQLite file (91⭐, May 2026) ⭐ NEW
- [agentkeeper](https://github.com/Thinklanceai/agentkeeper) - Cognitive persistence layer - memory survives provider switches, crashes, restarts (117⭐, May 2026) ⭐ NEW
- [DeepSeek-Reasonix](https://github.com/esengine/DeepSeek-Reasonix) - DeepSeek-native AI coding agent for your terminal with prefix-cache stability (3670⭐, May 2026) ⭐ NEW
- [edict](https://github.com/cft0808/edict) - OpenClaw Multi-Agent Orchestration System — 9 specialized AI agents with real-time dashboard (15780⭐, May 2026) ⭐ NEW
